...
// Re-exported for backward compatibility — these are pure (no filesystem
// access) and now live in lib/format.ts so client components can import
// them without pulling this module's node:fs usage into the browser bundle.
export {
  getReadingTime,
  formatDate,
  formatStamp,
